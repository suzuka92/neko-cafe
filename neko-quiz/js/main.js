...

{
    ...
    const quizSet = shuffle([
        ...
        {q: 'ねこが嫌がらないことは？' , c: ['あごの下なでること', '濡れること' ,'初めましての人' , 'トイレが汚いこと']},
        {q: 'ねこがふみふみしているときの気持ちで間違っているのは？' , c: ['むかつく〜', 'かまって〜' ,'ねむい〜' , '落ち着く〜']},
        {q: 'ねこがすりすりするときの気持ちは？' , c: ['においつけとこ', 'いいにおいするやん','はやくあそぼ','かゆい' ]},
        {q: 'ねこがしっぽをぶんぶん振るときの気持ちは？' , c: ['いらいら', '興奮してきた！' ,'たのしい' , 'お腹すいた']},
        {q: 'ねこがゴロンしてお腹を見せるときの気持ちは？' , c: ['こっち見て！', 'つかれた！' ,'お腹すいた！' , 'ねむい']},
        {q: 'ねこが耳を伏せたときの気持ちは？' , c: ['こわい', 'うれしい' ,'いらいら' , 'びっくり']},
        {q: 'ねこがゆっくり瞬きしているときの気持ちは？' , c: ['だいすき', 'ねむい' ,'きらい' , 'いらいら']},
        {q: 'ねこ「ア〜オ〜」と鳴くときの気持ちは？' , c: ['ムラムラする', 'かまって〜' ,'お腹すいた' , 'いらいら']},
        {q: 'ねこがしっぽをピーンとしているときの気持ちで間違っているのは？' , c: ['警戒！', 'うれしい' ,'かまって' , 'お腹すいた']},
    ]);
